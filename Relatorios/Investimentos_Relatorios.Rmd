...
# ------------------------------------------------------ Cod Tabela2 ----------------------------------------------------------
  ...
  if(pais %in% Investimentos::lista_paises_IDP_CF){
...
#-----------------------------------------------------------------------------------------------------------------------
    ...
    tabela_por_setor$Setores <- c("Indústrias Extrativas","Comércio, Reparação de Veículos Automotores e Motocicletas", "Eletricidade e Gás",
                                  "Indústrias de Transformação","Atividades Financeiras, de Seguros e Serviços Relacionados",
                                  "Transporte, Armazenagem e Correio","Outros")
  ...
  print("Sem dados para gerar o grafico!")
}
...
```{r, echo=FALSE,fig.width=10, fig.height=5.8, message=FALSE,warning = FALSE}
  if(IBD_Por_Setor != FALSE){
    kableExtra::kable(IBD_Por_Setor, format = "markdown", digits = 2)
  }else{
    print("Sem dados suficientes para gerar!")
  }
