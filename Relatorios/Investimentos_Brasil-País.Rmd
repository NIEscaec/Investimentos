...
```{r, echo=FALSE, message=FALSE, warning = FALSE}
  ...
  # pais <- c("Arábia Saudita", "Argélia", "Bahrein", "Catar", "Comores", "Djibouti", "Egito", "Emirados Árabes Unidos", "Iêmen", "Iraque", "Jordânia", "Kuwait", "Líbano", "Líbia", "Marrocos", "Mauritânia", "Palestina", "Omã", "Somália", "Sudão", "Tunísia", "Síria")
...
```{r, echo=FALSE, message=FALSE,warning = FALSE, message=FALSE, highlight=FALSE}
  ...
  lista_paises_IDP_II <- c("Países Baixos", "Estados Unidos", "Espanha", "Luxemburgo", "França", "Japão", "Reino Unido", "México", "Alemanha", "Canadá", "Ilhas Cayman", 
                           "Suíça", "Bermudas", "Chile", "Portugal", "Itália", "Austrália", "Áustria", "Ilhas Virgens Britânicas", "Uruguai", "Suécia", "Bélgica", "Noruega", "Panamá", "Argentina","Finlândia", "Colômbia", "Coréia do Sul", "Bahamas", "Irlanda", "Dinamarca", "Angola", "Barbados", "China", "Curaçao", "Chipre", "Cingapura", 
                           "Ilhas Jersey",
...
tabela_acoes.1 <- tabela_acoes %>% select(names, "2011", "2012", "2013", "2014", "2015")
tabela_acoes.2 <- tabela_acoes %>% select(names, "2016", "2017", "2018", "2019", "2020")
...
```{r, echo=FALSE,fig.width=10, fig.height=5.8, message=FALSE,warning = FALSE}
  ...
  tabela_acoes.1 <- rename(tabela_acoes.1, "Ativo" = "names")
  kableExtra::kable(tabela_acoes.1, digits = 2, format = "markdown", align = 'lcccccccccccc')
  
```

```{r, echo=FALSE,fig.width=10, fig.height=5.8, message=FALSE,warning = FALSE}

  tabela_acoes.2 <- rename(tabela_acoes.2, "Ativo" = "names")
  kableExtra::kable(tabela_acoes.2, digits = 2, format = "markdown", align = 'lcccccccccccc')
